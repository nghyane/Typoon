...
import { decodeJpeg } from "@typoon/shared/codec/jpeg-dec";
import { decodePng, isPng } from "@typoon/shared/codec/png-dec";
import { encodePng } from "@typoon/shared/codec/png-enc";
import { getBytes, putBytes, keys as r2keys } from "@typoon/shared/r2";
import type { ScanPageResult } from "@typoon/shared/types";
import { decodeMsgpack } from "@typoon/shared/codec/msgpack";
...
export async function runInpaintPage(
  ...
  const outKey  = r2keys.inpaint(String(args.chapter_id), args.page_index);
