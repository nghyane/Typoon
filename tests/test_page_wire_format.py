...
from typoon.stages.page import TranslationOp, _build_user, _parse_blocks
...
class TestParseBlocks:
    def test_happy_path(self, key_map):
        ...
        ops = _parse_blocks(text, {"ABC1234", "DEF5678"}, key_map)
        assert ops == [
    ...
    def test_code_fence_wrap_stripped(self, key_map):
        text = "```\n@@ ABC1234 dialogue\nhi\n```"
        ops = _parse_blocks(text, {"ABC1234"}, key_map)
    ...
    def test_unknown_key_dropped(self, key_map):
        ops = _parse_blocks("@@ ZZZZZZZ dialogue\nfoo", {"ZZZZZZZ"}, key_map)
        assert ops == []
    ...
    def test_auto_skip_rubble_forced(self):
        ...
        ops = _parse_blocks("@@ AAA0001 dialogue\nbogus", {"AAA0001"}, km)
