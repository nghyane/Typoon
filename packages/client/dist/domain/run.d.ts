...
export type PageTranslationStatus = 'queued' | 'loading' | 'preparing' | 'ocr' | 'detecting' | 'translating' | 'composing' | 'done' | 'error';
...
export interface TranslationRequest {
    ...
    readonly priority?: {
        readonly aroundPageIndex: number;
    };
