...
export type CapabilityStatus =
  | (CapabilityStatusBase & { readonly state: 'idle' })
  | (CapabilityStatusBase & { readonly state: 'resolving' })
  | (CapabilityStatusBase & { readonly state: 'downloading'; readonly progress: CapabilityProgress })
  | (CapabilityStatusBase & { readonly state: 'initializing' })
  | (CapabilityStatusBase & { readonly state: 'ready' })
  | (CapabilityStatusBase & { readonly state: 'failed'; readonly error: unknown })
