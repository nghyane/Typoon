...
class CTDMaskAugmenter:
    ...
    def augment(
        ...
        for g in groups:
            best_region = _best_match(g.bbox, ctd_result.text_regions)
...
def _best_match(lens_bbox, ctd_regions):
    """Return CTD region with highest IoU against lens_bbox, or None."""
